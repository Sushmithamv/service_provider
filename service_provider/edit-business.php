      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="p-6">
            <div class="">
            <?php
            $sql = mysqli_query($con,'SELECT * FROM service_info WHERE f_id = "'.$_SESSION['f_id'].'"');
              ...
              <form name="addpost" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <input type="text" name="f_name" id="f_name" value="<?php echo $row['f_service']; ?>">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card-box">
                      ...
                      <textarea class="summernote" name="postdescription"  required><?php echo $row['f_discription']?></textarea>
                    </div>
                  </div>
                </div>
                <!-- select a category -->
                       ...
                       $allowed_extensions = array(".jpg","jpeg",".png",".gif");
                        ...
                        {}
                          ...
                          $imgnewfile=md5($imgfile).$extension;
                              ...
                              $query=mysqli_query($con,'UPDATE service_info SET  f_id = "'.$user_id.'" , f_img="'.$imgnewfile.'",f_discription="'.$postdetails.'",f_service="'.$user_name.'",category="'.$catid.'" WHERE f_id = "'.$_SESSION['f_id'].'"');
                              if($query)
                              {
